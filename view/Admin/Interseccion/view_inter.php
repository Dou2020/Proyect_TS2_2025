<div class="my-5 relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            // Obtener usuarios
            include "../../../model/Admin/interseccion.php";

            $intersecciones = obtenerIntersecciones();
            foreach ($intersecciones as $usuario) {
            ?>
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <?php echo $usuario['avenida']; ?>
                </td>
                <td class="px-6 py-4">
                    <?php echo $usuario['calle']; ?>
                </td>
                <td class="px-6 py-4">
                    <?php echo $usuario['latitud']; ?>
                </td>
                <td class="px-6 py-4">
                    <?php echo $usuario['longitud']; ?>
                </td>
